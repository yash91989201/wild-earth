	...
	return (
		<div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 lg:grid-cols-2">
			...
			<motion.div
				...
				whileInView="visible"
			>
				<span className="mb-4 block font-bold text-[#d4af6a] text-xs uppercase tracking-[0.2em]">
					Our Ethos
				</span>
				<h2 className="mb-8 font-bold font-serif text-4xl text-[#1f4d2b] md:text-5xl">
